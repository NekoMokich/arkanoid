...
//Для измения скорости меча мы меняем значение в его информацие 
//т.е game.ball = {
//   dx: 0,
//    dy: 0,
//    velocity: 3 <----- и вот это значение отвечает за его скорость и то есть меняем на любое и оно будет работать

//для замены звука мы просто можем менять файл bump.mp3 на всё что мы захотим 